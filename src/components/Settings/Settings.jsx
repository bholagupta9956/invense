...
const submite=()=>{
  if(equipmentsName==""){
    toast("Equipment Name is Missing", {type:"warning"})
  } else if ( equipmentsModal==""){
    toast("Please Enter Equipment Modal" , {type:"warning"})
  }else if (equipmentsType=="") {
    toast(" Please Slect for Equipment Type", {type:"warning"})
  }
      ...
      <div className="block p-6 shadow-lg bg-white m ">
        <div>
            ...
            <div className="col-span-2 mt-3">
              ...
              <div className="mb-4">
                <input
                  ...
                  onChange={(e) => SetEquipemntsName(e.target.value)}
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 sm:col-span-3">
              <button className="bg-transparent w-full bg-primaryLogin text-primaryLogin font-semibold hover:text-white py-2 px-4 border border-primaryLogin hover:border-transparent rounded" onClick={submite}>
